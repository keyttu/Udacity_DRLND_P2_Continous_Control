...
## Instructions
Then run the [`DDPG_Continuous_Control.ipynb`](https://github.com/keyttu/Udacity_drlnd_p2_Continous_Control/blob/master/p2_Continous_Control.ipynb) notebook using the drlnd kernel to train the DDPG agent.
